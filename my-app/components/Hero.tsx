  ...
  return (
    <section className=" max-container padding-container flex flex-col gap-20 py-10 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className=" relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        />
        <h1 className=" bold-52 lg:bold-88 lg:w-[50%] ">
          Putuk truno Camp Area
        </h1>
        <p className=" regular-60 mt-6 text-gray-30 xl:max-w-[520px]">
          {' '}
          we want to be on each of your journeys seeking the satifsfaction of
        ...
        <div className=" relative flex flex-1 items-start lg:absolute lg:left-[50%]">
